  ...
  return (
    <div className="space-y-4 p-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Link href="/sales/visits/new" className="rounded-lg border p-3 hover:bg-accent">
          <p className="font-medium">New Check-in</p>
          <p className="text-xs text-muted-foreground">Photo + GPS + timestamp</p>
        </Link>
        <Link href="/sales/orders/new" className="rounded-lg border p-3 hover:bg-accent">
          <p className="font-medium">New Order</p>
          <p className="text-xs text-muted-foreground">Quick order entry</p>
        </Link>
        <Link href="/sales/customers" className="rounded-lg border p-3 hover:bg-accent">
          <p className="font-medium">Customers</p>
          <p className="text-xs text-muted-foreground">Browse assigned customers</p>
        </Link>
        <Link href="/sales/orders" className="rounded-lg border p-3 hover:bg-accent">
